...
#define MAVLINK_MSG_ID_PID_PARAMS_LEN 48
#define MAVLINK_MSG_ID_PID_PARAMS_MIN_LEN 48
#define MAVLINK_MSG_ID_11_LEN 48
#define MAVLINK_MSG_ID_11_MIN_LEN 48

#define MAVLINK_MSG_ID_PID_PARAMS_CRC 21
#define MAVLINK_MSG_ID_11_CRC 21
...
#define MAVLINK_MESSAGE_INFO_PID_PARAMS { \
    ...
    {  { "whe0_KP", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_pid_params_t, whe0_KP) }, \
         ...
         { "sta_KP", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_pid_params_t, sta_KP) }, \
         { "sta_KI", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_pid_params_t, sta_KI) }, \
         { "sta_KD", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_pid_params_t, sta_KD) }, \
         { "rob_KP", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_pid_params_t, rob_KP) }, \
         { "rob_KI", NULL, MAVLINK_TYPE_FLOAT, 0, 40, offsetof(mavlink_pid_params_t, rob_KI) }, \
         { "rob_KD", NULL, MAVLINK_TYPE_FLOAT, 0, 44, offsetof(mavlink_pid_params_t, rob_KD) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PID_PARAMS { \
...
static inline uint16_t mavlink_msg_pid_params_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float whe0_KP, float whe0_KI, float whe0_KD, float whe1_KP, float whe1_KI, float whe1_KD, float sta_KP, float sta_KI, float sta_KD, float rob_KP, float rob_KI, float rob_KD)
{
    ...
    _mav_put_float(buf, 24, sta_KP);
    _mav_put_float(buf, 28, sta_KI);
    _mav_put_float(buf, 32, sta_KD);
    _mav_put_float(buf, 36, rob_KP);
    _mav_put_float(buf, 40, rob_KI);
    _mav_put_float(buf, 44, rob_KD);
...
{
    return mavlink_msg_pid_params_pack(system_id, component_id, msg, pid_params->whe0_KP, pid_params->whe0_KI, pid_params->whe0_KD, pid_params->whe1_KP, pid_params->whe1_KI, pid_params->whe1_KD, pid_params->sta_KP, pid_params->sta_KI, pid_params->sta_KD, pid_params->rob_KP, pid_params->rob_KI, pid_params->rob_KD);
}
...
{
    return mavlink_msg_pid_params_pack_chan(system_id, component_id, chan, msg, pid_params->whe0_KP, pid_params->whe0_KI, pid_params->whe0_KD, pid_params->whe1_KP, pid_params->whe1_KI, pid_params->whe1_KD, pid_params->sta_KP, pid_params->sta_KI, pid_params->sta_KD, pid_params->rob_KP, pid_params->rob_KI, pid_params->rob_KD);
}
...
static inline void mavlink_msg_pid_params_send(mavlink_channel_t chan, float whe0_KP, float whe0_KI, float whe0_KD, float whe1_KP, float whe1_KI, float whe1_KD, float sta_KP, float sta_KI, float sta_KD, float rob_KP, float rob_KI, float rob_KD)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PID_PARAMS_LEN];
    _mav_put_float(buf, 0, whe0_KP);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_pid_params_send(chan, pid_params->whe0_KP, pid_params->whe0_KI, pid_params->whe0_KD, pid_params->whe1_KP, pid_params->whe1_KI, pid_params->whe1_KD, pid_params->sta_KP, pid_params->sta_KI, pid_params->sta_KD, pid_params->rob_KP, pid_params->rob_KI, pid_params->rob_KD);
#else
 ...
 */
static inline void mavlink_msg_pid_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float whe0_KP, float whe0_KI, float whe0_KD, float whe1_KP, float whe1_KI, float whe1_KD, float sta_KP, float sta_KI, float sta_KD, float rob_KP, float rob_KI, float rob_KD)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field sta_KP from pid_params message
 *
 * @return  Stability control KP
 */
static inline float mavlink_msg_pid_params_get_sta_KP(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  24);
}

/**
 * @brief Get field sta_KI from pid_params message
 *
 * @return  Stability control KI
 */
static inline float mavlink_msg_pid_params_get_sta_KI(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  28);
}

/**
 * @brief Get field sta_KD from pid_params message
 *
 * @return  Stability control KD
 */
static inline float mavlink_msg_pid_params_get_sta_KD(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  32);
}

/**
 * @brief Get field rob_KP from pid_params message
 *
 * @return  Robot velocity control KP
 */
static inline float mavlink_msg_pid_params_get_rob_KP(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  36);
}

/**
 * @brief Get field rob_KI from pid_params message
 *
 * @return  Robot control KI
 */
static inline float mavlink_msg_pid_params_get_rob_KI(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  40);
}

/**
 * @brief Get field rob_KD from pid_params message
 *
 * @return  Robot control KD
 */
static inline float mavlink_msg_pid_params_get_rob_KD(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_pid_params_decode(const mavlink_message_t* msg, mavlink_pid_params_t* pid_params)
{
    ...
    pid_params->sta_KP = mavlink_msg_pid_params_get_sta_KP(msg);
    pid_params->sta_KI = mavlink_msg_pid_params_get_sta_KI(msg);
    pid_params->sta_KD = mavlink_msg_pid_params_get_sta_KD(msg);
    pid_params->rob_KP = mavlink_msg_pid_params_get_rob_KP(msg);
    pid_params->rob_KI = mavlink_msg_pid_params_get_rob_KI(msg);
    pid_params->rob_KD = mavlink_msg_pid_params_get_rob_KD(msg);
#else
