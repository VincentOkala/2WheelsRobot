...
#define MAVLINK_MSG_ID_IMU_PARAMS_LEN 14
#define MAVLINK_MSG_ID_IMU_PARAMS_MIN_LEN 14
#define MAVLINK_MSG_ID_9_LEN 14
#define MAVLINK_MSG_ID_9_MIN_LEN 14

#define MAVLINK_MSG_ID_IMU_PARAMS_CRC 167
#define MAVLINK_MSG_ID_9_CRC 167
...
#define MAVLINK_MESSAGE_INFO_IMU_PARAMS { \
    ...
    "IMU_PARAMS", \
    5, \
    {  { "gyro_offet_x", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_imu_params_t, gyro_offet_x) }, \
         { "gyro_offet_y", NULL, MAVLINK_TYPE_INT16_T, 0, 10, offsetof(mavlink_imu_params_t, gyro_offet_y) }, \
         { "gyro_offet_z", NULL, MAVLINK_TYPE_INT16_T, 0, 12, offsetof(mavlink_imu_params_t, gyro_offet_z) }, \
         { "angle_ajusted", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_imu_params_t, angle_ajusted) }, \
...
{
    return mavlink_msg_imu_params_pack(system_id, component_id, msg, imu_params->gyro_offet_x, imu_params->gyro_offet_y, imu_params->gyro_offet_z, imu_params->angle_ajusted, imu_params->believe_in_gyro);
}
...
{
    return mavlink_msg_imu_params_pack_chan(system_id, component_id, chan, msg, imu_params->gyro_offet_x, imu_params->gyro_offet_y, imu_params->gyro_offet_z, imu_params->angle_ajusted, imu_params->believe_in_gyro);
}
...
static inline void mavlink_msg_imu_params_send(mavlink_channel_t chan, int16_t gyro_offet_x, int16_t gyro_offet_y, int16_t gyro_offet_z, float angle_ajusted, float believe_in_gyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IMU_PARAMS_LEN];
    _mav_put_float(buf, 0, angle_ajusted);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_imu_params_send(chan, imu_params->gyro_offet_x, imu_params->gyro_offet_y, imu_params->gyro_offet_z, imu_params->angle_ajusted, imu_params->believe_in_gyro);
#else
 ...
 */
static inline void mavlink_msg_imu_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int16_t gyro_offet_x, int16_t gyro_offet_y, int16_t gyro_offet_z, float angle_ajusted, float believe_in_gyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field gyro_offet_x from imu_params message
 *
 * @return  Gyro Offset X
 */
static inline int16_t mavlink_msg_imu_params_get_gyro_offet_x(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  8);
}

/**
 * @brief Get field gyro_offet_y from imu_params message
 *
 * @return  Gyro Offset Y
 */
static inline int16_t mavlink_msg_imu_params_get_gyro_offet_y(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  10);
}

/**
 * @brief Get field gyro_offet_z from imu_params message
 *
 * @return  Gyro Offset Z
 */
static inline int16_t mavlink_msg_imu_params_get_gyro_offet_z(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  12);
}

/**
 * @brief Get field angle_ajusted from imu_params message
 *
 * @return  Angle ajusted
 */
static inline float mavlink_msg_imu_params_get_angle_ajusted(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    imu_params->angle_ajusted = mavlink_msg_imu_params_get_angle_ajusted(msg);
    imu_params->believe_in_gyro = mavlink_msg_imu_params_get_believe_in_gyro(msg);
    imu_params->gyro_offet_x = mavlink_msg_imu_params_get_gyro_offet_x(msg);
    imu_params->gyro_offet_y = mavlink_msg_imu_params_get_gyro_offet_y(msg);
    imu_params->gyro_offet_z = mavlink_msg_imu_params_get_gyro_offet_z(msg);
#else
