...
#define MAVLINK_MSG_ID_MOTOR_SPEED 6

MAVPACKED(
typedef struct __mavlink_motor_speed_t {
 int32_t motor_speed_0; /*<  Motor 0 speed*/
 int32_t motor_speed_1; /*<  Motor 1 Speed*/
}) mavlink_motor_speed_t;

#define MAVLINK_MSG_ID_MOTOR_SPEED_LEN 8
#define MAVLINK_MSG_ID_MOTOR_SPEED_MIN_LEN 8
#define MAVLINK_MSG_ID_6_LEN 8
#define MAVLINK_MSG_ID_6_MIN_LEN 8

#define MAVLINK_MSG_ID_MOTOR_SPEED_CRC 20
#define MAVLINK_MSG_ID_6_CRC 20
...
#define MAVLINK_MESSAGE_INFO_MOTOR_SPEED { \
    ...
    "MOTOR_SPEED", \
    2, \
    {  { "motor_speed_0", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_motor_speed_t, motor_speed_0) }, \
         { "motor_speed_1", NULL, MAVLINK_TYPE_INT32_T, 0, 4, offsetof(mavlink_motor_speed_t, motor_speed_1) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MOTOR_SPEED { \
...
static inline uint16_t mavlink_msg_motor_speed_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               int32_t motor_speed_0, int32_t motor_speed_1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MOTOR_SPEED_LEN];
    _mav_put_int32_t(buf, 0, motor_speed_0);
    _mav_put_int32_t(buf, 4, motor_speed_1);
...
static inline void mavlink_msg_motor_speed_send(mavlink_channel_t chan, int32_t motor_speed_0, int32_t motor_speed_1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MOTOR_SPEED_LEN];
    _mav_put_int32_t(buf, 0, motor_speed_0);
 ...
 */
static inline void mavlink_msg_motor_speed_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t motor_speed_0, int32_t motor_speed_1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_motor_speed_get_motor_speed_0(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_motor_speed_get_motor_speed_1(const mavlink_message_t* msg)
{
