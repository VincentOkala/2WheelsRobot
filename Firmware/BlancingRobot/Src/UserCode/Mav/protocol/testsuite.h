...
static void mavlink_test_cmd_set_gyro_offset(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CMD_SET_GYRO_OFFSET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_cmd_set_gyro_offset_t packet_in = {
        17235,17339,17443
    };
    mavlink_cmd_set_gyro_offset_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CMD_SET_GYRO_OFFSET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CMD_SET_GYRO_OFFSET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_gyro_offset_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_cmd_set_gyro_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_gyro_offset_pack(system_id, component_id, &msg , packet1.gyro_offet_x , packet1.gyro_offet_y , packet1.gyro_offet_z );
    mavlink_msg_cmd_set_gyro_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_gyro_offset_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gyro_offet_x , packet1.gyro_offet_y , packet1.gyro_offet_z );
    mavlink_msg_cmd_set_gyro_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cmd_set_gyro_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_gyro_offset_send(MAVLINK_COMM_1 , packet1.gyro_offet_x , packet1.gyro_offet_y , packet1.gyro_offet_z );
    mavlink_msg_cmd_set_gyro_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_cmd_set_accel_offset(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CMD_SET_ACCEL_OFFSET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_cmd_set_accel_offset_t packet_in = {
        17235,17339,17443
    };
    mavlink_cmd_set_accel_offset_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CMD_SET_ACCEL_OFFSET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CMD_SET_ACCEL_OFFSET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_accel_offset_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_cmd_set_accel_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_accel_offset_pack(system_id, component_id, &msg , packet1.accel_offet_x , packet1.accel_offet_y , packet1.accel_offet_z );
    mavlink_msg_cmd_set_accel_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_accel_offset_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.accel_offet_x , packet1.accel_offet_y , packet1.accel_offet_z );
    mavlink_msg_cmd_set_accel_offset_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cmd_set_accel_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_accel_offset_send(MAVLINK_COMM_1 , packet1.accel_offet_x , packet1.accel_offet_y , packet1.accel_offet_z );
    mavlink_msg_cmd_set_accel_offset_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_cmd_set_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CMD_SET_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_cmd_set_pid_t packet_in = {
        17.0,45.0,73.0
    };
    mavlink_cmd_set_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CMD_SET_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CMD_SET_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_cmd_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_pid_pack(system_id, component_id, &msg , packet1.KP , packet1.KI , packet1.KD );
    mavlink_msg_cmd_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.KP , packet1.KI , packet1.KD );
    mavlink_msg_cmd_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cmd_set_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cmd_set_pid_send(MAVLINK_COMM_1 , packet1.KP , packet1.KI , packet1.KD );
    mavlink_msg_cmd_set_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_protocol(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_cmd_set_gyro_offset(system_id, component_id, last_msg);
    mavlink_test_cmd_gyro_offset(system_id, component_id, last_msg);
    mavlink_test_cmd_set_accel_offset(system_id, component_id, last_msg);
    ...
    mavlink_test_cmd_set_pid(system_id, component_id, last_msg);
