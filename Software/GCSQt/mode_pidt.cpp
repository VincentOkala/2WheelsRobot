...
void MainWindow::pid_w0_plot(uint32_t len){
    ...
    ui->plot_w0->xAxis->setRange(len-PID_VECTOR_LEN, len);
    ui->plot_w0->yAxis->setRange(min_y-10,max_y+10);
    ui->plot_w0->graph(0)->setData(pid_w0_x,pid_w0_p_y);
    ui->plot_w0->graph(1)->setData(pid_w0_x,pid_w0_i_y);
    ui->plot_w0->graph(2)->setData(pid_w0_x,pid_w0_d_y);
    ui->plot_w0->graph(3)->setData(pid_w0_x,pid_w0_u_y);
    ui->plot_w0->replot();
...
//    max_y = max_y > 0 ? 150 : max_y;
    ui->plot_w0_err->xAxis->setRange(len-PID_VECTOR_LEN, len);
    ui->plot_w0_err->yAxis->setRange(min_y-10,max_y+10);
    ui->plot_w0_err->graph(0)->setData(pid_w0_x,pid_w0_sp_y);
    ui->plot_w0_err->graph(1)->setData(pid_w0_x,pid_w0_fb_y);
    ui->plot_w0_err->replot();
}
...
void MainWindow::pid_w1_plot(uint32_t len){
    ...
    ui->plot_w1->xAxis->setRange(len-PID_VECTOR_LEN, len);
    ui->plot_w1->yAxis->setRange(min_y-10,max_y+10);
    ui->plot_w1->graph(0)->setData(pid_w1_x,pid_w1_p_y);
    ui->plot_w1->graph(1)->setData(pid_w1_x,pid_w1_i_y);
    ui->plot_w1->graph(2)->setData(pid_w1_x,pid_w1_d_y);
    ui->plot_w1->graph(3)->setData(pid_w1_x,pid_w1_u_y);
    ui->plot_w1->replot();
...
//    min_y = min_y < 0 ? -150 : min_y;
//    max_y = max_y > 0 ? 150 : max_y;
    ui->plot_w1_err->xAxis->setRange(len-PID_VECTOR_LEN, len);
    ui->plot_w1_err->yAxis->setRange(min_y-10,max_y+10);
    ui->plot_w1_err->graph(0)->setData(pid_w1_x,pid_w1_sp_y);
    ui->plot_w1_err->graph(1)->setData(pid_w1_x,pid_w1_fb_y);
    ui->plot_w1_err->replot();
}
...
void MainWindow::pid_sync_plot(uint32_t len){
    ...
    ui->plot_sync_err->xAxis->setRange(len-PID_VECTOR_LEN, len);
    ui->plot_sync_err->yAxis->setRange(min_y-1,max_y+1);
    ui->plot_sync_err->graph(0)->setData(pid_s_x,pid_s_sp_y);
    ui->plot_sync_err->graph(1)->setData(pid_s_x,pid_s_fb_y);
    ui->plot_sync_err->replot();
}
